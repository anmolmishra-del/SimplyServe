...
class RestaurantDetailPageUiMatch extends StatefulWidget {
  ...
  @override
  State<RestaurantDetailPageUiMatch> createState() =>
      _RestaurantDetailPageUiMatchState();
}

class _RestaurantDetailPageUiMatchState
    extends State<RestaurantDetailPageUiMatch> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Proceed (demo)')),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppColors.primary,
                      ...
                      children: [
                        Row(
                          children: const [
                            ...
                            SizedBox(width: 8),
                            Text(
                              'Authentic Biryani & Indian\'s Cuisine',
